const debug = require('node:util').debuglog('cnpm:config');
...
module.exports = {
  ...
  registryWebMap: {
    'https://registry.npmjs.org': 'https://npmx.dev',
  },
  disturl: 'https://cdn.npmmirror.com/binaries/node', // download dist tarball for node-gyp
